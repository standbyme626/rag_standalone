# Apache 2.0 License Header — Original copyright: Copyright 2024 The InfiniFlow Authors
...
def _ensure_pil_image(img):
    """Ensure img is a PIL Image. Accepts numpy array bytes path or PIL.Image."""
    import numpy as np
