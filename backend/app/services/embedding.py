...
class EmbeddingService:
    ...
    def _initialize(self):
        ...
        self.siliconflow_enabled = bool(getattr(settings, "SILICONFLOW_ENABLED", True))
        ...
        self.use_siliconflow = self.siliconflow_enabled and bool(self.siliconflow_api_key)
        if self.siliconflow_api_key and not self.siliconflow_enabled:
            print(
                "[EmbeddingService] SILICONFLOW_API_KEY is set but SILICONFLOW_ENABLED=false; cloud embedding disabled."
            )
